...
<section class="benefite_section">
    <div class="container">
        <div class="product_start mx-auto">
            <div class="row">
                <div class="col-md-6 pr-0">
                    <div class="benefit_images">
                        <div class="main_image">
                            <img src="img/benefit-1.png" class="img-fluid" alt="">
                        </div>
                        <div class="sub_images">
                            <figure>
                                <img src="img/benefit-2.png" class="img-fluid" alt="">
                            </figure>
                            <figure>
                                <img src="img/benefit-3.png" class="img-fluid" alt="">
                            </figure>
                        </div>
                    </div>
                </div>
...
<section class="marketing_section">
    <div class="container">
        <div class="product_start mx-auto">
            <div class="marketing_top_text text-center">
                <div class="icon_img">
                    <img src="img/taj.png" alt="">
                </div>
                <h4>Marketing</h4>
